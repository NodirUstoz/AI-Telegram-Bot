...
A [Telegram bot](https://core.telegram.org/bots/api) that integrates with OpenAI's _official_ [ChatGPT](https://openai.com/blog/chatgpt/), [DALL·E](https://openai.com/product/dall-e-2) and [Whisper](https://openai.com/research/whisper) APIs to provide AI-powered answers. Ready to use with minimal configuration required.

## Screenshots

Screenshots and demo images can be added here.
...
- [x] Support *new models* [announced on June 13, 2025](https://openai.com/blog/function-calling-and-other-api-updates)
...
- [x] Support GPT-4 Turbo and DALL·E 3 [announced on November 6, 2025](https://openai.com/blog/new-models-and-developer-products-announced-at-devday)
- [x] Text-to-speech support [announced on November 6, 2025](https://platform.openai.com/docs/guides/text-to-speech)
- [x] Vision support [announced on November 6, 2025](https://platform.openai.com/docs/guides/vision)
- [x] GPT-4o model support [announced on May 12, 2025](https://openai.com/index/hello-gpt-4o/)
...
| `MAX_TOKENS`                        | Upper bound on how many tokens the AI API will return                                                                                                                                                                                                                              | `1200` for GPT-3, `2400` for GPT-4 |
...
| `VOICE_REPLY_WITH_TRANSCRIPT_ONLY`  | Whether to answer to voice messages with the transcript only or with an AI response of the transcript                                                                                                                                                                               | `false`                            |
...
| `crypto`                  | Live cryptocurrencies rate (powered by [CoinCap](https://coincap.io))                                 | -                                                                    |                     |
...
| `deepl_translate`         | Translate text to any language (powered by [DeepL](https://deepl.com))                              | `DEEPL_API_KEY`                                                      |                     |
| `gtts_text_to_speech`     | Text to speech (powered by Google Translate APIs)                                                                                                   | -                                                                    | `gtts`              |
| `whois`                   | Query the whois domain database                                                                       | -                                                                    | `whois`             |
| `webshot`                 | Screenshot a website from a given url or domain name                                          | -                                                                    |                     |
| `auto_tts`                | Text to speech using OpenAI APIs                                                                            | -                                                                    |                     |
...
```shell
git clone https://github.com/nodirustoz/ai-telegram-bot.git
cd ai-telegram-bot
```
...
You can also use a Docker image from Docker Hub:

```shell
docker pull nodirustoz/ai-telegram-bot:latest
docker run -it --env-file .env nodirustoz/ai-telegram-bot
```

or using the GitHub Container Registry:

```shell
docker pull ghcr.io/nodirustoz/ai-telegram-bot:latest
docker run -it --env-file .env ghcr.io/nodirustoz/ai-telegram-bot
```

#### Docker manual build
```shell
docker build -t nodirustoz/ai-telegram-bot .
docker run -it --env-file .env nodirustoz/ai-telegram-bot
```
